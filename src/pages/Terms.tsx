const Terms = () => {
  return (
    <section className="bg-[var(--bg-color)] text-[var(--text-color)] pt-28">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500">Last updated: August 03, 2024</p>
        </div>
          ...
          <section className="mb-8">
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <li>
                  <strong>Website</strong> refers to www.extechnology.in,
                  accessible from www.extechnology.in
                </li>
                <li>
          ...
          <section>
            ...
            <div className="space-y-4">
              ...
              <p>
                By email:{" "}
                <a
                  href="mailto:info@extechnology.in"
