...
const AboutUs = () => {
  return (
    <div className="relative bg-[var(--bg-color)] text-[var(--text-color)] px-4 py-12 md:px-16 lg:px-24">
      <div>
        <h1 className="md:text-7xl text-5xl pt-24 pb-14 font-bold text-center">About Us</h1>
      </div>
      {/* Purple Top Shadow */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        <div className="relative md:flex space-y-5  gap-6">
          <div className="relative md:top-40">
            ...
            />
            <div className="absolute top-0 left-0 w-full h-full border-2 border-dashed border-cyan-400 rounded-lg pointer-events-none" />
          </div>
          ...
          <div className="relative md:-top-40">
            <img
              ...
              className="rounded-lg w-full object-cover"
            />
            <div className="absolute top-0 left-0 w-full h-full border-2 border-dashed border-purple-500 rounded-lg pointer-events-none" />
          </div>
        ...
        <div className="relative z-10">
          ...
          <p className="text-2xl leading-relaxed whitespace-pre-line text-justify ">
          ...
          <p className="text-2xl pt-3 leading-relaxed whitespace-pre-line text-justify">
          ...
          <div className="absolute -bottom-8 -right-8 w-28 h-28 bg-purple-400 blur-3xl rounded-full opacity-30 z-0" />
        </div>
      </div>
    </div>
  );
