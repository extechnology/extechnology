const Privacy = () => {
  return (
    <section className="bg-[var(--bg-color)] text-[var(--text-color)] pt-28">
      <div className=" max-w-7xl mx-auto privacy-policy py-4 px-3 px-md-5">
        <div className="policy-header text-center mb-5">
          <h1 className="mb-3">Privacy Policy</h1>
          <p className="text-muted">Last updated: August 03, 2024</p>
        </div>
        ...
        <div className="policy-content">
          ...
          <section className="mb-5">
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Interpretation</h3>
              <p>
            ...
            <div>
              <h3 className="h4 mb-3">Definitions</h3>
          ...
          <section className="mb-5">
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Types of Data Collected</h3>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Tracking Technologies and Cookies</h3>
              <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Use of Your Personal Data</h3>
              <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Retention of Your Personal Data</h3>
              <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Transfer of Your Personal Data</h3>
              <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Delete Your Personal Data</h3>
              <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Disclosure of Your Personal Data</h3>
              <div className="mb-3">
                <h4 className="h5 mb-2">Business Transactions</h4>
                <p>
              ...
              <div className="mb-3">
                <h4 className="h5 mb-2">Law enforcement</h4>
                <p>
              ...
              <div>
                <h4 className="h5 mb-2">Other legal requirements</h4>
                <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Security of Your Personal Data</h3>
              <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Children's Privacy</h3>
              <p>
            ...
            <div className="mb-4">
              <h3 className="h4 mb-3">Links to Other Websites</h3>
              <p>
            ...
            <div>
              ...
              <p>
                By email:{" "}
                <a href="mailto:info@extechnology.in">info@extechnology.in</a>
              </p>
            </div>
          </section>
        </div>
